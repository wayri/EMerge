from mumps_emerge import ZMumpsContextSeq, ZMumpsContextPar
...
class MUMPSInterfacePar:
    def __init__(self):
        self.ctx = ZMumpsContextPar(1,0)
        self.ctx.set_silent()
...
class MUMPSInterfaceSeq:
    def __init__(self):
        self.ctx = ZMumpsContextSeq(1,0)
        self.ctx.set_silent()
        self._analysed = False
        self._factorized = False
        self.ctx.id.icntl[17] = 0
        self.ctx.id.icntl[6]  = 5      # METIS
        self.ctx.id.icntl[27] = 0      # ICNTL(28)
        self.ctx.id.icntl[28] = 0      # ICNTL(29) automatic (safe)
        self.ctx.id.icntl[47] = 0
